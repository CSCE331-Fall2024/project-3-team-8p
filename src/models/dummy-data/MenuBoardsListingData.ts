...
const listings: Record<Tabs, MenuBoardItem[]> = {
    [Tabs.Entrees]: [
        new MenuBoardItem("1", 4.40, "Beijing Beef", MenuItemCategory.Entree, {allergens: ["soy"], fat: 1, sugar: 2, protein: 3, carbohydrates: 4, calories: 5, isSpicy: true, isPremium: true}),
    ...
    [Tabs.Sides]: [
    new MenuBoardItem("1", 4.40, "Beijing Beef", MenuItemCategory.Side, {allergens: ["soy"], fat: 1, sugar: 2, protein: 3, carbohydrates: 4, calories: 5, isSpicy: true, isPremium: true}),
